  ...
  return (
    <Layout>
      ...
      <div>
        ...
        <h3>1. URL Coffee</h3>
        <p>
          I really really like URL. Never thought of myself as much of an artistic or designerly person (hopefully that can change!) but even I can tell that the interior 
        ...
        <div style={{ 
          ...
          <p style={{ 
            ...
            The airy interior and fellow Seattleites on laptops. Image courtesy of Yelp.
          </p>
        </div>
        
        <p>
          I've gotten plenty of work done on the main table in the middle, and baristas will kindly bring your drink out to you after you get seated.
        ...
        <p>
          I think my guilty pleasure might just be escaping to Cap Hill. Was even considering trying to rent a studio here, 
        ...
        <p>
          Prices are pretty fair. Baristas are always friendly and it seems that lots of regulars are here! (I wish I came more often so they remembered my order...)
        </p>
        ...
        <p>
          Their prices are their main selling point. I also really like their wood notes and slightly dimmer atmosphere.
        </p>

        <p>
          I always grab a bag of their espresso roast. Their pastries are good too, I believe they're from Macrina Bakery? Should check that out too.
        </p>

        <h3>Conclusion</h3>

        <p>
          I think the key that ties all of this together is Seattle's walkability and generally impressive public transportation. Coming from California, you basically need to have a car to get anywhere; public transportation is very sparse besides a few train lines and some cross-city buses. 
          Where I grew up in San Jose, I'm not sure that I even knew about coffee besides Starbucks. Now, I'm enlightened! 
        </p>
