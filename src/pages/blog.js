...
import { FaLinkedin, FaGraduationCap, FaHome, FaBlog, FaChevronDown, FaChevronUp } from 'react-icons/fa';
...
const Blog = () => {
  ...
  return (
    ...
    {/* <div className = "navbar">
        <a href='/'>Home</a>
        <a className="currentPage" href="/blog">Blog</a>
    </div> */}
    ...
    <div className="navbar">
      ...
      <a className="currentPage" href="/blog">
